...
public class ApplicationTimer {
    ...
    private final ActivatorThread th;
  
    @Inject
    public ApplicationTimer(Clock clock, ApplicationLifecycle appLifecycle, ActivatorThread th) {
        this.clock = clock;
        ...
        // ApplicationLifecycle object. d code inside the stop hook will
